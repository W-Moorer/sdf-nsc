...
def main():
    ...
    mesh_t, mesh_a, mesh_b = load_series(OUTPUT_DIR / "headon_spheres_massratio_mesh.csv")
    sdf1_t, sdf1_a, sdf1_b = load_series(OUTPUT_DIR / "headon_spheres_massratio_sdf1.csv")
    sdf2_t, sdf2_a, sdf2_b = load_series(OUTPUT_DIR / "headon_spheres_massratio_sdf2.csv")
    ...
    ax.set_title("Head-on Unequal-Mass Sphere Impact Benchmark")
    ...
    pdf_path = FIG_DIR / "headon_spheres_massratio_benchmark.pdf"
    png_path = FIG_DIR / "headon_spheres_massratio_benchmark.png"
